    ...
    extends TestCase
{
        ...
        throws Exception
    {
        ...
        PrivateKeyInfo pkInfo = info.decryptPrivateKeyInfo(new JcePKCSPBEInputDecryptorProviderBuilder().setProvider("SC").build("hello".toCharArray()));
        ...
        throws Exception
    {
        ...
        PrivateKeyInfo pkInfo = encInfo.decryptPrivateKeyInfo(new JcePKCSPBEInputDecryptorProviderBuilder().setProvider("SC").build("hello".toCharArray()));
