    ...
    extends SimpleTest
{
    ...
    {
        KeyStore store1 = KeyStore.getInstance("BCFKS", "SC");
        ...
        KeyStore store2 = KeyStore.getInstance("BCFKS", "SC");
    ...
    public void shouldStoreOneCertificate()
        throws Exception
    {
        X509Certificate cert = (X509Certificate)CertificateFactory.getInstance("X.509", "SC").generateCertificate(new ByteArrayInputStream(trustedCertData));
        ...
        throws KeyStoreException, NoSuchProviderException, IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        store2 = KeyStore.getInstance("BCFKS", "SC");
    ...
    public void shouldStoreOneECKeyWithChain()
        throws Exception
    {
        KeyPairGenerator kpGen = KeyPairGenerator.getInstance("EC", "SC");
    ...
    private void checkOnePrivateKeyDef(PrivateKey key, X509Certificate[] certs, char[] passwd)
        throws Exception
    {
        KeyStore store1 = KeyStore.getInstance("BCFKS-DEF", "SC");
