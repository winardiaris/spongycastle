    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        SecretKeyFactory kFact = SecretKeyFactory.getInstance("TLS10KDF", "SC");
        ...
        throws Exception
    {
        ...
        SecretKeyFactory kFact = SecretKeyFactory.getInstance("TLS11KDF", "SC");
        ...
        throws Exception
    {
        ...
        SecretKeyFactory kFact = SecretKeyFactory.getInstance("TLS12withSHA256KDF", "SC");
        ...
        throws Exception
    {
        ...
        SecretKeyFactory kFact = SecretKeyFactory.getInstance("TLS12withSHA384KDF", "SC");
        ...
        throws Exception
    {
        ...
        SecretKeyFactory kFact = SecretKeyFactory.getInstance("TLS12withSHA512KDF", "SC");
