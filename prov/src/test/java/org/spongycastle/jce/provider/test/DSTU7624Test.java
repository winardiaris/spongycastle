    ...
    extends BaseBlockCipherTest
{
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance(name + "/ECB/NoPadding", "SC");
        out = Cipher.getInstance(name + "/ECB/NoPadding", "SC");
        ...
        throws Exception
    {
        ...
        Cipher c1 = Cipher.getInstance(oid.getId(), "SC");
        Cipher c2 = Cipher.getInstance(name, "SC");
        KeyGenerator kg = KeyGenerator.getInstance(oid.getId(), "SC");
        ...
        throws Exception
    {
        ...
        Mac m1 = Mac.getInstance(oid.getId(), "SC");
        Mac m2 = Mac.getInstance(name, "SC");
        KeyGenerator kg = KeyGenerator.getInstance(oid.getId(), "SC");
