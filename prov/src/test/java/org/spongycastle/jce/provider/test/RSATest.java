    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        c = Cipher.getInstance("RSA/NONE/OAEPWith" + digest + "AndMGF1Padding", "SC");
        ...
        AlgorithmParameters parameters = AlgorithmParameters.getInstance("OAEP", "SC");
        ...
        throws Exception
    {
        ...
        Cipher c = Cipher.getInstance("RSA/ECB/PKCS1Padding", "SC");
    ...
    public void zeroMessageTest()
        throws Exception
    {
        KeyPairGenerator kgen = KeyPairGenerator.getInstance("RSA", "SC");
        ...
        rsaCipher = Cipher.getInstance("RSA/NONE/OAEPWithSHA1AndMGF1Padding", "SC");
