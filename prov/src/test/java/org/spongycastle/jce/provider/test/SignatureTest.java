    ...
    extends SimpleTest
{
    ...
    private void checkSig(KeyPair kp, String name)
        throws Exception
    {
        Signature sig = Signature.getInstance(name, "SC");
...
//        checkSig(kp, "RIPEMD160withRSA/ISO9796-2PSS");
        ...
        kpGen = KeyPairGenerator.getInstance("EC", "SC");
        ...
        kpGen = KeyPairGenerator.getInstance("ECGOST3410", "SC");
        ...
        kpGen = KeyPairGenerator.getInstance("GOST3410", "SC");
