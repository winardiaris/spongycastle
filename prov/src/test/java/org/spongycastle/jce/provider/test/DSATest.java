    ...
    extends SimpleTest
{
    ...
    private void testModified()
        throws Exception
    {
        KeyFactory kFact = KeyFactory.getInstance("DSA", "SC");
        PublicKey pubKey = kFact.generatePublic(PUBLIC_KEY);
        Signature sig = Signature.getInstance("DSA", "SC");
        ...
        throws Exception
    {
        ...
        KeyFactory ecKeyFact = KeyFactory.getInstance("EC", "SC");
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, InvalidKeySpecException, SignatureException
    {
        ...
        Signature dsa = Signature.getInstance(sigName, "SC");
        ...
        throws Exception
    {
        ...
        KeyFactory dsaKeyFact = KeyFactory.getInstance("DSA", "SC");
    ...
    private void testKeyGeneration(int keysize)
        throws Exception
    {
        KeyPairGenerator generator = KeyPairGenerator.getInstance("DSA", "SC");
