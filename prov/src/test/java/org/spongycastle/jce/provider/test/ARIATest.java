    ...
    extends BaseBlockCipherTest
{
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("ARIA/ECB/NoPadding", "SC");
        out = Cipher.getInstance("ARIA/ECB/NoPadding", "SC");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("ARIA/EAX/NoPadding", "SC");
        out = Cipher.getInstance("ARIA/EAX/NoPadding", "SC");
        ...
        try
        {
            in = Cipher.getInstance("ARIA/EAX/PKCS5Padding", "SC");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("ARIA/CCM/NoPadding", "SC");
        out = Cipher.getInstance("ARIA/CCM/NoPadding", "SC");
        ...
        try
        {
            in = Cipher.getInstance("ARIA/CCM/PKCS5Padding", "SC");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("ARIA/GCM/NoPadding", "SC");
        out = Cipher.getInstance("ARIA/GCM/NoPadding", "SC");
        ...
        try
        {
            in = Cipher.getInstance("ARIA/GCM/PKCS5Padding", "SC");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("ARIA/OCB/NoPadding", "SC");
        out = Cipher.getInstance("ARIA/OCB/NoPadding", "SC");
        ...
        try
        {
            in = Cipher.getInstance("ARIA/OCB/PKCS5Padding", "SC");
