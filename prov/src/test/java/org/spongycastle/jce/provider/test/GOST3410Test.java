...
//                    new BigInteger("57896044618658097711785492504343953927082934583725450622380973592137631069619")); // q
        ...
        throws Exception
    {
        ...
        KeyFactory f = KeyFactory.getInstance("ECGOST3410-2012", "SC");
        PrivateKey sKey = f.generatePrivate(priKey);
        PublicKey vKey = f.generatePublic(pubKey);
        ...
        KeyPairGenerator g = KeyPairGenerator.getInstance("ECGOST3410-2012", "SC");
        ...
        throws Exception
    {
        ...
        PrivateKey sKey = p.getPrivate();
        PublicKey vKey = p.getPublic();
        Signature s = Signature.getInstance(signatureAlg, "SC");
        s.initSign(sKey);
        ...
        s = Signature.getInstance(signatureAlg, "SC");
