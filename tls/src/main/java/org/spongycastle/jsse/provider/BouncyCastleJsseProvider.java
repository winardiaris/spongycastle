    ...
    extends Provider
{
    ...
    private void configure(boolean isInFipsMode, final JcaTlsCryptoProvider baseCryptoProvider)
    {
        ...
        {
            addAlgorithmImplementation("SSLContext.SSL", "org.spongycastle.jsse.provider.SSLContext.TLS", new EngineCreator()
            {
                public Object createInstance(Object constructorParameter)
                {
        ...
        addAlgorithmImplementation("SSLContext.TLS", "org.spongycastle.jsse.provider.SSLContext.TLS", new EngineCreator()
        {
            public Object createInstance(Object constructorParameter)
            {
                return new ProvSSLContextSpi(baseCryptoProvider);
        ...
        addAlgorithmImplementation("SSLContext.TLSv1", "org.spongycastle.jsse.provider.SSLContext.TLS.1", new EngineCreator()
        {
            public Object createInstance(Object constructorParameter)
            {
                return new ProvSSLContextSpi(baseCryptoProvider);
        ...
        addAlgorithmImplementation("SSLContext.Default", "org.spongycastle.jsse.provider.SSLContext.TLS.Default", new EngineCreator()
        {
            public Object createInstance(Object constructorParameter)
            {
                return new ProvSSLContextSpi(baseCryptoProvider);
